...
set -g status-format[0] "#[align=right]#{S:#[range=session|#{session_id}]#{?#{==:#{session_name},#{client_session}},#[fg=colour248]#[bg=colour234]#[nobold]#[nounderscore]#[noitalics]#[fg=colour235]#[bg=colour248]#[bold] #{session_name} #[fg=colour235]#[bg=colour248]#[fg=colour235]#[bg=colour248] #{s/[$$]//p:session_id} #[fg=colour234]#[bg=colour248]#[bg=colour234]#[nobold]#[nounderscore]#[noitalics],#[fg=colour250]#[bg=colour234] #{session_name} #[fg=colour244]#[bg=colour234]#[fg=colour244]#[bg=colour234] #{s/[$$]//p:session_id} }#[norange]}#[fg=colour236]#[bg=colour234]#[nobold]#[nounderscore]#[noitalics]#[fg=colour247]#[bg=colour236]  "
